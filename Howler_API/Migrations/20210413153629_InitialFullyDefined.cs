...
{
    public partial class InitialFullyDefined : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    avatarBackground = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Folllows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Folllows_Users_FollowedById",
                        column: x => x.FollowedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Folllows_Users_FollowingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Folllows_FollowedById",
                table: "Folllows",
                column: "FollowedById");

            migrationBuilder.CreateIndex(
                name: "IX_Folllows_FollowingId",
                table: "Folllows",
                column: "FollowingId");
